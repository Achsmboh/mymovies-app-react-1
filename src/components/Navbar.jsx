...
function Navbar({ onChange, onSubmit }) {
  ...
  return (
    <div className="navbar bg-glass  text-white ">
      ...
      <div className="w-full flex justify-center">
        <form onSubmit={onSubmit} className="form-control lg:w-2/3 md:w-2/3 w-32 h-9 ">
          <input type="text" placeholder="Search" className="input input-bordered bg-white  text-black" onChange={onChange} />
        </form>
      </div>
